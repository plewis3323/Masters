...
#define R__DICTIONARY_FILENAME RawCluster_Dict
...
namespace ROOT {
   static void delete_RawCluster(void *p);
   static void deleteArray_RawCluster(void *p);
   static void destruct_RawCluster(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::RawCluster*)
   {
      ::RawCluster *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::RawCluster >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("RawCluster", ::RawCluster::Class_Version(), "", 22,
                  typeid(::RawCluster), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::RawCluster::Dictionary, isa_proxy, 4,
                  sizeof(::RawCluster) );
      instance.SetDelete(&delete_RawCluster);
      instance.SetDeleteArray(&deleteArray_RawCluster);
      instance.SetDestructor(&destruct_RawCluster);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::RawCluster*)
   {
      return GenerateInitInstanceLocal(static_cast<::RawCluster*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::RawCluster*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr RawCluster::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *RawCluster::Class_Name()
{
   return "RawCluster";
}

//______________________________________________________________________________
const char *RawCluster::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RawCluster*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int RawCluster::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::RawCluster*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *RawCluster::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RawCluster*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *RawCluster::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::RawCluster*)nullptr)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
void RawCluster::Streamer(TBuffer &R__b)
{
   // Stream an object of class RawCluster.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(RawCluster::Class(),this);
   } else {
      R__b.WriteClassBuffer(RawCluster::Class(),this);
   }
}
...
namespace ROOT {
   ...
   static void delete_RawCluster(void *p) {
      delete (static_cast<::RawCluster*>(p));
   }
   static void deleteArray_RawCluster(void *p) {
      delete [] (static_cast<::RawCluster*>(p));
   }
   static void destruct_RawCluster(void *p) {
      typedef ::RawCluster current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::RawCluster

namespace {
  void TriggerDictionaryInitialization_RawCluster_Dict_Impl() {
...
#line 1 "RawCluster_Dict dictionary payload"
...
"RawCluster", payloadCode, "@",
nullptr
};
    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("RawCluster_Dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_RawCluster_Dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_RawCluster_Dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_RawCluster_Dict() {
  TriggerDictionaryInitialization_RawCluster_Dict_Impl();
}
