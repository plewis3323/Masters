...
#define R__DICTIONARY_FILENAME SvtxVertex_v2_Dict
...
namespace ROOT {
   static void *new_SvtxVertex_v2(void *p = nullptr);
   static void *newArray_SvtxVertex_v2(Long_t size, void *p);
   static void delete_SvtxVertex_v2(void *p);
   static void deleteArray_SvtxVertex_v2(void *p);
   static void destruct_SvtxVertex_v2(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::SvtxVertex_v2*)
   {
      ::SvtxVertex_v2 *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::SvtxVertex_v2 >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("SvtxVertex_v2", ::SvtxVertex_v2::Class_Version(), "", 17,
                  typeid(::SvtxVertex_v2), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::SvtxVertex_v2::Dictionary, isa_proxy, 4,
                  sizeof(::SvtxVertex_v2) );
      instance.SetNew(&new_SvtxVertex_v2);
      instance.SetNewArray(&newArray_SvtxVertex_v2);
      instance.SetDelete(&delete_SvtxVertex_v2);
      instance.SetDeleteArray(&deleteArray_SvtxVertex_v2);
      instance.SetDestructor(&destruct_SvtxVertex_v2);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::SvtxVertex_v2*)
   {
      return GenerateInitInstanceLocal(static_cast<::SvtxVertex_v2*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::SvtxVertex_v2*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr SvtxVertex_v2::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *SvtxVertex_v2::Class_Name()
{
   return "SvtxVertex_v2";
}

//______________________________________________________________________________
const char *SvtxVertex_v2::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::SvtxVertex_v2*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int SvtxVertex_v2::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::SvtxVertex_v2*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *SvtxVertex_v2::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::SvtxVertex_v2*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *SvtxVertex_v2::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::SvtxVertex_v2*)nullptr)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
void SvtxVertex_v2::Streamer(TBuffer &R__b)
{
   // Stream an object of class SvtxVertex_v2.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(SvtxVertex_v2::Class(),this);
   } else {
      R__b.WriteClassBuffer(SvtxVertex_v2::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_SvtxVertex_v2(void *p) {
      return  p ? new(p) ::SvtxVertex_v2 : new ::SvtxVertex_v2;
   }
   static void *newArray_SvtxVertex_v2(Long_t nElements, void *p) {
      return p ? new(p) ::SvtxVertex_v2[nElements] : new ::SvtxVertex_v2[nElements];
   }
   // Wrapper around operator delete
   static void delete_SvtxVertex_v2(void *p) {
      delete (static_cast<::SvtxVertex_v2*>(p));
   }
   static void deleteArray_SvtxVertex_v2(void *p) {
      delete [] (static_cast<::SvtxVertex_v2*>(p));
   }
   static void destruct_SvtxVertex_v2(void *p) {
      typedef ::SvtxVertex_v2 current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::SvtxVertex_v2
...
namespace {
  void TriggerDictionaryInitialization_SvtxVertex_v2_Dict_Impl() {
...
#line 1 "SvtxVertex_v2_Dict dictionary forward declarations' payload"
...
#line 1 "SvtxVertex_v2_Dict dictionary payload"
...
"SvtxVertex_v2", payloadCode, "@",
nullptr
};
    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("SvtxVertex_v2_Dict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_SvtxVertex_v2_Dict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_SvtxVertex_v2_Dict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_SvtxVertex_v2_Dict() {
  TriggerDictionaryInitialization_SvtxVertex_v2_Dict_Impl();
}
